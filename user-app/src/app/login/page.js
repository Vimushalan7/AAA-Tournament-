  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full blur-[120px] pointer-events-none"
           style={{ background: 'rgba(255,50,50,0.10)' }} />
      ...
      <div className="w-full max-w-md relative z-10 text-center"
           style={{
             ...
             borderRadius: '2px',
             boxShadow: '0 0 40px rgba(255,107,0,0.15), 0 0 80px rgba(0,0,0,0.1)',
             clipPath: 'polygon(0 0, calc(100% - 16px) 0, 100% 16px, 100% 100%, 16px 100%, 0 calc(100% - 16px))',
             padding: '40px 36px',
           }}>
        
        <div className="mb-8">
          <img src="/logo.jpeg" alt="Alpha Ace Arena Logo" className="w-24 h-24 object-cover mx-auto mb-6 rounded-full border-2 border-ff-orange shadow-[0_0_15px_rgba(255,107,0,0.3)]" />
          <h1 style={{ fontFamily: 'Oswald, sans-serif', fontSize: '36px', fontWeight: 900, color: '#1a1a1a', letterSpacing: '0.05em', textTransform: 'uppercase', textShadow: '2px 2px 0px rgba(255,107,0,0.2)' }}>
            ALPHA ACE ARENA
          </h1>
          <p style={{ color: '#FF6B00', fontSize: '10px', letterSpacing: '0.4em', textTransform: 'uppercase', fontFamily: 'Share Tech Mono, monospace', marginTop: '4px' }}>
            ENTER THE ARENA WITH GOOGLE
          </p>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center">
            <div style={{ color: '#FF6B00', fontFamily: 'Oswald, sans-serif', letterSpacing: '0.2em' }}>PROCESSING...</div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col items-center">
          ...
          <a href="mailto:alpha.ace.support@gmail.com" className="inline-flex items-center gap-1.5 text-xs font-bold text-ff-orange hover:text-ff-orange/80 transition-colors uppercase tracking-wider">
            <AlertCircle size={14} />
            Help & Support
          </a>
        </div>
